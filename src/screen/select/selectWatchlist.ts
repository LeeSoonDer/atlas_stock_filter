...
/**
 * TASK_CARD_05 SCOPE 2. Two passes, per SCOPE's stated priority order:
 *
 * 1. "挤压蓄势桶未入选者优先": every symbol whose PRIMARY bucket is
 *    volatility_compression_setup but wasn't selected as a candidate,
 *    sorted by score (highest first).
 * 2. "其余桶临界未达标者(<=10%)补足": remaining slots filled by
